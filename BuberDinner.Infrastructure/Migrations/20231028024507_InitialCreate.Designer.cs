...
namespace BuberDinner.Infrastructure.Migrations
{
    ...
    [Migration("20231028024507_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BuberDinner.Domain.MenuAggregates.Entities.Menu", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("BuberDinner.Domain.MenuAggregates.Entities.Menu", b =>
                {
                    ...
                    b.OwnsMany("BuberDinner.Domain.DinnerAggregates.ValueObjects.DinnerId", "DinnerIds", b1 =>
                        {
                            b1.Property<int>("Id")
                                .HasColumnType("int");
                    ...
                    b.OwnsMany("BuberDinner.Domain.MenuAggregates.Entities.MenuSection", "Sections", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uniqueidentifier")
                            ...
                            b1.OwnsMany("BuberDinner.Domain.MenuAggregates.Entities.MenuItem", "Items", b2 =>
                                {
                                    b2.Property<Guid>("Id")
                                        .HasColumnType("uniqueidentifier")
                    ...
                    b.OwnsMany("BuberDinner.Domain.MenuReviewAggregates.ValueObjects.MenuReviewId", "MenuReviewIds", b1 =>
                        {
                            b1.Property<int>("Id")
                                .HasColumnType("int");
